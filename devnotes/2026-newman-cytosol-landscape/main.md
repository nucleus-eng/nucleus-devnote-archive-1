...
:::{figure} #fig:mg-ribo-t7-interactions
...
:::{figure} #fig:pairplot-8-factor
:label: fig-pairplot-8-factor
:align: center
:width: 100%

8-factor Discovery Plate: ATP, creatine phosphate, DNA, GTP, magnesium acetate, PolyP, PPK and tRNA, coloured by binned steady state.
:::
